...
@Autonomous(name = "Auto: Depot", group = "RuckusAuto")
public class DepotAuto extends LinearOpMode {

    private RuckusHardware ruckusHardware;
    private AutoHelper autoHelper;
    private String opModeName = "AutoDepot";
...
//5s    //turn 90 degree right until seeing gold mineral
        ...
        if(lfTicks < 0 && lrTicks < 0) {
            //left mineral
            autoHelper.driveAndWait(900, 0, 0, 2, 3);
            autoHelper.driveAndWait(0, 0, -70, 2, 3);
            autoHelper.driveAndWait(0, 75, 0, 0.25, 0.5);
            autoHelper.driveAndWait(650, 0, 0, 2, 3);
        } else if(lfTicks > 600 && lrTicks > 600) {
            //right mineral
            autoHelper.driveAndWait(950, 0, 0, 2, 3);
            autoHelper.driveAndWait(0, 0, 70, 2, 3);
            autoHelper.driveAndWait(650, 0, 0, 2, 3);
        } else {
            //middle mineral
            autoHelper.driveAndWait(1200, 0, 0, 2, 3);
        }
